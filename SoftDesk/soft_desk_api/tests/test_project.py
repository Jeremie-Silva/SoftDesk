...
class ProjectAPI(APITestCase):
    ...
    def test_project_post_full_data(self):
        ...
        self.assertEqual(new_project.author, self.contributor_1)
        self.assertIn(self.contributor_1, new_project.contributors.all())
        self.assertTrue(hasattr(new_project, "created_time"))
    ...
    def test_project_put_obj(self):
        ...
        self.assertEqual(new_project.description, "aaa")
        self.assertEqual(new_project.author, self.contributor_1)
